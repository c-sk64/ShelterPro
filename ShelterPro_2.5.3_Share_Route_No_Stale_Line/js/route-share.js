/* Shelter Pro 2.5.3 - Active route sharing */
(function () {
  'use strict';
  ...
  function ensureButtons() {
    ...
    if (driveActions && !document.getElementById('shareActiveRoute')) {
      const b = document.createElement('button');
      b.id = 'shareActiveRoute';
      b.textContent = '↗ Share Route';
      b.addEventListener('click', openModal);
      driveActions.insertBefore(b, driveActions.firstChild);
    }

    const routeActions = document.querySelector('#routeScreen .sp-row-actions');
    if (routeActions && !document.getElementById('routeShareFromManager')) {
      const b = document.createElement('button');
      b.id = 'routeShareFromManager';
      b.textContent = '↗ Share Route';
      b.addEventListener('click', openModal);
      routeActions.insertBefore(b, routeActions.firstChild);
    }
  }
